...
def test_simple_cyphering():
	...
	plugboard = {'b':'t', 'c':'u', 'f':'q', 'g':'z', 'i':'a', 'j':'o', 'n':'v',
				 'p':'e', 's': 'l', 'y':'m'}
	encrypted_message = enigma(message, rotors, ('a', 'a', 'a'), plugboard)
	decrypted_message = enigma(encrypted_message, rotors, ('a', 'a', 'a'), plugboard)
